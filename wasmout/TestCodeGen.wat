(module 
  ...
  (func $TestCodeGen_sum (param i32 i32) (result i32) 
    get_local 0
    get_local 1
    i32.add
  )
  (export "TestCodeGen_main" (func $TestCodeGen_main))
  (func $TestCodeGen_main (local i32 i32 i32 i32)
    i32.const 1
    set_local 0
    i32.const 2
    set_local 1
