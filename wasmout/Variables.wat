(module 
  ...
  (func $O_toList (param i32) (result i32) (local i32 i32 i32 i32 i32 i32)
    get_local 0
    set_local 1
    get_local 1
    i32.load
  ...
  (func $Variables_create (param i32) (result i32) (local i32 i32 i32 i32)
    get_local 0
    set_local 1
    get_local 1
    i32.const 1
  ...
  (func $Variables_pow (param i32 i32) (result i32) (local i32)
    get_local 1
    i32.const 0
    i32.eq
    if (result i32)
  ...
  (export "Variables_main" (func $Variables_main))
  (func $Variables_main (local i32 i32 i32 i32)
    i32.const 4
    set_local 0
    i32.const 3
    set_local 1
