...
import java.io.{StringReader, InputStream, ByteArrayInputStream}
import org.junit.Test

class CodegenTests extends TestSuite {
 
  val baseDir = "test/resources/codegen" // Note: You can change this to reuse interpreter tests.
                                         // You would have to recover them from an older commit
  val outputExt = "txt"
