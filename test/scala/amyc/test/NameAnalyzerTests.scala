...
class NameAnalyzerTests extends TestSuite {
  ...
  @Test def testBindersDuplicate = shouldFail("BindersDuplicate")

  @Test def testBindersDuplicate2 = shouldFail("BindersDuplicate2")*/

  // NEW TESTS
  @Test def testValReassign = shouldFail("ValReassign")
}
